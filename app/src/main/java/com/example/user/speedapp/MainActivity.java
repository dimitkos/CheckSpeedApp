...
public class MainActivity extends AppCompatActivity implements SensorEventListener,LocationListener {
    ...
    public void onLocationChanged(Location location) {
        //metrepw ta knots se xilometra
        velocity = location.getSpeed()*1.852;
        textView.setText(String.format(" %.2f", velocity) + " " + " km per hour");
    ...
    public void violations(View view)
    {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM Velocity order by timestamp desc ;",null);
